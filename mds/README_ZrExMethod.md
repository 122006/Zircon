...
4. 为什么以外部对象为调用方的动态拓展方法声明成员方法引用时报错了？
...
6. 为什么拓展方法需要import相关声明类？
   > 在实际注入点声明前，引入涉及到的相关类，以保证能够正确替换
   > 插件已支持自动引包

7. 相比lombok、manifold等有什么优势呢
   ...
   > 4. lambda表达式、成员方法引用支持：支持面更广（但是还有罕见两个场景在适配中）
   > 
