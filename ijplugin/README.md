...
当前 IDEA 插件版本为 **4.9**，编译依赖版本为 **3.3.2**，两者独立管理。
...
插件声明兼容 `212–261.*`（IDEA 2021.2–2026.1）。现有验证结果：

- Plugin Verifier：2022.3.3、2024.2.1、2025.3.1.1、2026.1.4 均为 Compatible。
- 语法回归：2025.3.1.1、2026.1.4 各 8 项测试通过。
- 2021.2 尚未实测；2022.3.3、2024.2.1 当前完成的是静态兼容检查，尚未补齐旧版编辑器运行测试。
