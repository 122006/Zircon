...
public class ZrExpressionParser extends ExpressionParser {
    ...
    public ZrExpressionParser(@NotNull JavaParser javaParser) {
        ...
        if (useNewImplementation) {
            BasicPrattExpressionParser prattExpressionParser = this.reflectionFieldValue("myNewExpressionParser");
            Map<IElementType, Object> ourInfixParsers = prattExpressionParser.reflectionFieldValue("ourInfixParsers");
//            BasicPrattExpressionParser.ParserData
//            ourInfixParsers.put(JavaTokenType.QUEST, new BasicPrattExpressionParser.ParserData(12, conditionalExprParser));
        }
    }
