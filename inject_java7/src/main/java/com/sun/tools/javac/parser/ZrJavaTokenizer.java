...
public class ZrJavaTokenizer extends JavaTokenizer {
    ...
    @Override
    protected void lexError(int position, String key, Object... arguments) {
        super.lexError(Item.remapPosition(position, activeCodeItem, groupStartIndex), key, arguments);
    }
